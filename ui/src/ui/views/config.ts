        ...
        <nav class="config-nav">
          ...
          ${allSections.map(section => html`
            ...
            >
              ...
              <span class="config-nav__label">${(t("config").sections as any)[section.key] ?? section.label}</span>
            </button>
          `)}
        </nav>
      ...
      <main class="config-main">
        ...
        <div class="config-actions">
          <div class="config-actions__left">
            ${hasChanges ? html`
              <span class="config-changes-badge">${props.formMode === "raw"
        ? t("config").unsavedChanges
        : t("config").unsavedChangesCount.replace("{count}", String(diff.length))
      }</span>
            ` : html`
      ...
      ? html`
              <div class="config-section-hero">
                ...
                <div class="config-section-hero__text">
                  <div class="config-section-hero__title">${(t("config").sections as any)[props.activeSection ?? ""] ?? activeSectionMeta.label}</div>
